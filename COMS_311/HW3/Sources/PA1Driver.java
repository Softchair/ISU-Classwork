...
public class PA1Driver {
    ...
    public double testing(TestInfo test){
		...
		double finalPts = test.points * (numOfPathsCorrect * 0.5 + planCorrect * 0.5);
    ...
    */
    private void readTests() throws NumberFormatException, IOException{
        ...
        for(int i=0; i<testCount; i++){
            String inFilename = "HW3/Sources/tests/in/input" + i + ".txt";
            String outFilename = "HW3/Sources/tests/out/output" + i + ".txt";
            ...
            tests.add(new TestInfo(inFilename, shorterFilename, shortestPath, numOfPaths, points, 300, validator));
