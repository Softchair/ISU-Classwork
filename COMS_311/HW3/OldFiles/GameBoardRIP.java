...
//
//        //Create a key
//        StateKey curStateKey = new StateKey(initialState.getVehicles());
//
...
//        if (gameboard.getVehicles().get(0).getLocation()[1] == 18) {
...
//
//            //Create a key
//            StateKey workingStateKey = new StateKey(workingState.getVehicles());
//
...
//            State parentState = copyState(workingState);
//
//            if (workingState.level == endState.level - 1) {
//
//                //Create a key
//                StateKey workingStateKey = new StateKey(workingState.getVehicles());
//
...
//                    if (workingFutureState.getVehicles().get(0).getLocation()[1] == 0) {
...
//
//            //Create a key
//            StateKey workingFutureStateKey = new StateKey(workingFutureState.getVehicles());
//            System.out.println("statekey 1: " + workingFutureStateKey.hashCode());
//
//            boolean visited = visitedStates.containsKey(workingFutureStateKey);
//            State visited2 = visitedStates.get(workingFutureStateKey);
//            if (visited2 != null) {
//                System.out.println("This bro exists");
//            }
//
...
//
//                    //Adding a copy of the state
//                    endState = copyState(workingFutureState);
//                    numOfEndStates++;
//                    pathsGenerated = true;
//                    return true;
//                }
...
//
//                        StateKey hashKey = new StateKey(validState.getVehicles());
//
...
//                return curState.checkIfValid(valueAtWhereVehicleWantsToMove);
...
//
//        /**
//     * Returns true if there exists a vehicle
//     * @param v location to move to
//     * @return if the spot is open
//     */
//    public boolean checkIfValid(int v) {
//        for (int i = 0; i < vehicles.size(); i++) {
//            Vehicle cur = vehicles.get(i);
//
//            for (int j = 0; j < cur.getLocation().length; j++) {
//                int curLoc = cur.getLocation()[j];
//                if (curLoc == v) {
//                    return false;
//                }
//            }
...
//
//    public StateKey(ArrayList<Vehicle> vehicles) {
...
//        return vehicles.equals(stateKey.vehicles);
//    }
//
//    @Override
//    public int hashCode() {
//        //int hash = Arrays.hashCode(vehicles.toArray());
//        int hash = 0;
