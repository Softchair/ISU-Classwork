...
//    private HashMap<HashMap, State> visitedStates; //Holding the visited states
...
//        //visitedStates.put(initialState.getGameboard(), initialState); todo fix visited states
//
//
//        //No possible path
...
//
//            //visitedStates.put(workingState.getGameboard(), workingState); todo fix visited states
//
...
//
//                //visitedStates.put(workingState.getGameboard(), workingState); todo fix visited staes
//
//                //Generates all the next possible states
//                ArrayList<State> futureStates = getNextStates(workingState);
//
...
//        for (State workingFutureState : futureStates) {
//            //if (!visitedStates.containsKey(workingFutureState.getGameboard())) { todo fix visited states
