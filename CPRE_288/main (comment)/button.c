...
uint8_t button_getButton() {
    ...
    if((GPIO_PORTE_DATA_R & 0b0001) == 0){

        Button_Pressed = 1;

    }else if((GPIO_PORTE_DATA_R & 0b0010) == 0){

        Button_Pressed = 2;

    }else if((GPIO_PORTE_DATA_R & 0b0100) == 0){

        Button_Pressed = 3;

    }else if((GPIO_PORTE_DATA_R & 0b1000) == 0){
