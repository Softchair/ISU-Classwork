...
public class Donuts
{
   ...
   */
  private static double donutHelper(int coffees, int donuts)
  {
    int dozens = donuts / 12;
    int singles = donuts % 12;
    int freeCoffees = dozens * 2;
    coffees = Math.min(freeCoffees - freeCoffees, 0);
