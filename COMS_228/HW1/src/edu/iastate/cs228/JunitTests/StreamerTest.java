...
class StreamerTest {
    ...
    @Test
    void who() {
        TownCell testCell = new Streamer(testTown, 1, 1);
        State temp = testCell.who();
        assertEquals(State.STREAMER, temp);
    }

    @Test
    void nextOutage() { //Outage
    ...
    void nextEmpty() { //Empty
        ...
        testTown.grid[1][0] = new Outage(testTown, 1, 0);
    ...
    void nextEmptyOutage() { //Empty + Outage
        ...
        TownCell tempTownCell = testTown.getCell(testTown, 1, 0);
        TownCell tempState = tempTownCell.next(testTown);
    ...
    void nextCasual() { //Casual
        ...
        testTown.grid[1][1] = new Casual(testTown, 1, 1);
        testTown.grid[1][2] = new Streamer(testTown, 1, 2);
        ...
        TownCell tempTownCell = testTown.getCell(testTown, 1, 2);
        TownCell tempState = tempTownCell.next(testTown);
